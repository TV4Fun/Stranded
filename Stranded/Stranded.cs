...
namespace Stranded {
  ...
  public class Stranded : MonoBehaviour {
    private List<MechBill.MechBill> _kerbals;
    ...
    public void Start() {
      ...
      _kerbals = new List<MechBill.MechBill>();
    ...
    public MechBill.MechBill SpawnAIKerbal(Vector3 position) {
      ...
      eva.vessel.orbit.referenceBody = FlightGlobals.getMainBody(eva.transform.position);
